...
# print(arithmetic_arranger(['99 + 100']))
# Test problems
...
# print(json.dumps(problems_dict, sort_keys=False, indent=4))
...
for line in lines:
    ...
    for i in range(len(problems_list)):
        ...
        if line == 'number_1':
            print(' '*(problems_list[i][problems[i]]['max_digit_len'] - 
        ...
        # Print out lines for the second integer
            ...
            print(problems_list[i][problems[i]]['arithmetic_sign'] + 
        ...
        # Print out line for the dashes
            ...
            print('-'*(problems_list[i][problems[i]]['max_digit_len'] + 2), 
                  end='    ')
